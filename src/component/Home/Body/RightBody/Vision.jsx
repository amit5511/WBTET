  ...
  return <>
    <div class="body-right">
      ...
      <div class="content_doc">
        <p style={{"font-size":'16px'}}><b>Our Vision</b></p>
        <p class="pclass">Basically
          with a view to attaining the goals of education for all at the primary
          level (5+ to 9+ age group under the jurisdiction of Primary Education)
          the Board proposes to ensure</p><br /><br />
        <p class="pclass">(i)
          universal access,</p>
        <p class="pclass">(ii)
        ...
        <p class="pclass">Obviously,
          ...
          by the Act (W.B.Primary Education Act, 1973 as amended from time to time)
